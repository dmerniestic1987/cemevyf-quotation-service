...
export class InitialCommit1730389325448 implements MigrationInterface {
    name = 'InitialCommit1730389325448'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`health_order_results\` (\`id\` varchar(36) NOT NULL, \`mimeType\` varchar(70) NOT NULL, \`file_data\` mediumblob NULL, \`additional_notes\` text NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`order_id\` bigint NULL, INDEX \`IDX_5b9933910e8fc62353cf9b6bb2\` (\`mimeType\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`health_order_files\` (\`id\` varchar(36) NOT NULL, \`mimeType\` varchar(70) NOT NULL, \`file_data\` mediumblob NULL, \`additional_notes\` text NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`order_id\` bigint NULL, INDEX \`IDX_1963cae78fc7fd733f026f11ae\` (\`mimeType\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_5b9933910e8fc62353cf9b6bb2\` ON \`health_order_results\``);
